   ...
   public synchronized String attendClient(Client client) {
      try {
         ...
         if (transactionNumber > 5) {
            ...
            return "Client" + " " + client.getId() + " " + "attended successfully" + "." + " " + client.getTransactionNumber() + " " + "transactions left" + ".";
         } else {
            client.setTransactionNumber(0);
            return "Client" + " " + client.getId() + " " + "attended successfully" + "." + " " + "No transactions left" + ".";
         }
      }
   }
}
